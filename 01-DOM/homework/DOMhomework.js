...
createdBy.innerHTML+= ' Fernando Adrogué Benas'
...
function buildToDos(toDos) {
  // Tu código acá:
  const toDoSells = toDos.map(buildToDo)
  return toDoSells
}
...
function displayToDos() {
  ...
  const toDoSells = buildToDos(toDoItems)
  toDoSells.forEach(function (toDoSell){
    toDoContainer.appendChild(toDoSell)
  })
}
